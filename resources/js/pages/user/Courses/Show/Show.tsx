...
export default function CourseDetailPage({ course, purchases, totalPurchasesCount }) {
    ...
    from-blue-400/90 via-purple-400/90 to-indigo-500/90
    dark:from-blue-700/90 dark:via-purple-700/90 dark:to-indigo-800/90
    py-12 px-4 sm:px-6 lg:px-8 relative">
